...
TEST_CASE("A StickerSheet with stickers placed beyond base image boundaries works", "[weight=5][part=2][valgrind][timeout=30000]") {
  ...
  // check if lose image 
  // Image test0 = sheet.render();
  // test0.writeToFile("../data/test0.png");

  sheet.removeSticker(1);
  //chech if lose image 
  // Image test1 = sheet.render();
  // test1.writeToFile("../data/test1.png");

  const Image &renderXBound = sheet.render();
  // Image test2 = sheet.render();
  // test2.writeToFile("../data/test2.png");
  ...
  sheet.removeSticker(0);
 std::cout << "reached 1" << std::endl;
  // Image test = sheet.render();
  // test.writeToFile("../data/test.png");
  REQUIRE( sheet.render() == alma );
std::cout << "reached 2" << std::endl;
...
std::cout << "reached -2" << std::endl;
  ...
  Image test5 = sheet.render();
  test5.writeToFile("../data/test5.png");
std::cout << "reached here" << std::endl;
  sheet.removeSticker(0);
  std::cout << "reached 3" << std::endl;
  Image test4 = sheet.render();
  test4.writeToFile("../data/test4.png");
  REQUIRE( sheet.render() == alma );
